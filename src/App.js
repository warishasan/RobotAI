    ...
    <div>
      ...
      <div id="background1">
        <div className="firstblock">
          ...
          <p id="tagline">
            Start integrating different aspects of your project easily and
            efficiently. Many libraries supported
          </p>
      ...
      <div className="secondblock">
        <div className="text">
          <h1 ref={text1.ref} id="animatedText">
            Design{" "}
          </h1>
          <h1 ref={dot1.ref} id="animatedText">
            <b>.</b>{" "}
          </h1>
          <h1 ref={text2.ref} id="animatedText">
            Develop{" "}
          </h1>
          <h1 ref={dot2.ref} id="animatedText">
            <b>.</b>{" "}
          </h1>
          <h1 ref={text3.ref} id="animatedText">
            Integrate
          </h1>
        </div>
        <div className="imgs">
      ...
      <div className="thirdblock">
        <div className="animatedIconsGroup1">
          <img
            ref={matlab1.ref}
            id="matlab"
            src={matlab}
          ...
          <img
            ref={slam1.ref}
            id="slam"
            src="https://img.pngio.com/alex-wong-slam-png-300_114.png"
            alt="slam"
          ></img>
        </div>
        <h1 id="tagline2">Integrate with any platform using any language</h1>

        <div className="animatedIconsGroup2">
      ...
      <div className="fourthblock">
        <div>
          <img id="r1" src={robot1} alt="robot5"></img>
          <h2>Highly Optimized Debugging Tools</h2>
          <p>
            We provide a user-friendly graphical interface that allows you to
            debug at each step of iteration using advnaced AI techniques
          </p>
        </div>

        <div>
          <img id="r2" src={robot2} alt="robot6"></img>
          <h2>Highly Fluid Work Flow</h2>
          <p>
            Our architecture allows you to integrate all aspects of designing
            and coding in the same package seamlessly
          </p>
        </div>

        <div>
          <img id="r3" src={robot3} alt="robot7"></img>
          <h2>Great Modularity</h2>
          <p>
            We allow you do design your prototypes in a modular fashion so that
            each aspect of the development can be handled independently
          </p>
        </div>
      </div>
    </div>
